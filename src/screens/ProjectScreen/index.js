        ...
        <>
            ...
            <Container sx={{ mt: 18 }}>
                ...
                <Stack direction={{ md: 'row', xs: 'column' }} spacing={2}>
                    ...
                    in={true}>
                        <Card>
                            <h3>Meu Serviço <Badge>Completo</Badge></h3>
                            <p>
                                Um projeto mobile e web, com um intuito de ser um &rdquo;marketplace&rdquo; para serviços. Contará com um aplicativo mobile para o cliente poder procurar o serviço que precisa naquele momento e uma plataforma web para o prestador de serviços.
                            </p>

                            <StackArea>
                                <Image title="React.js" src="/images/logoReact.webp" alt="Logo Next" width="30" height="30"/>
                                <Image title="Node.js" src="/images/nodejs.png" alt="Logo Next" width="30" height="30"/>
                                <Image title="Material UI" src="/images/logoMui.png" alt="Logo Mui" width="30" height="30"/>
                            </StackArea>

                            <LinkArea>
                                <Link href="https://projeto-meu-servico.vercel.app" passHref>
                                    <a target="_blank">
                                        Visualizar
                                    </a>
                                </Link>
